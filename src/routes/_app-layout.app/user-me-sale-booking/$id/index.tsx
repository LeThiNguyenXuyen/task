...
const Page: React.FunctionComponent<PageProps> = () => {
    ...
    return (
        <div className="relative flex h-full w-full flex-col">
            <NKLink className="absolute left-4 top-4 z-10" href={NKRouter.app.userMeSaleBooking.index()}>
            ...
            <div className="absolute right-4 top-4 z-10 flex gap-2">
                ...
                <NKLink href={NKRouter.app.userMeSaleBooking.edit(id)}>
...
export const Route = createFileRoute('/_app-layout/app/user-me-sale-booking/$id/')({
    component: Page,
});
