    ...
    return (
        <div className="relative flex h-full w-full flex-col">
            <div className="relative flex h-fit w-full items-start justify-start bg-blue-600 p-4">
                <NKLink href={NKRouter.app.userMeSale.index()}>
                    ...
                    <form id="cart" onSubmit={formMethods.handleSubmit(onSubmit)}>
                        <div>
                            <div className="grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-4">
                                ...
                                <div className="sm:col-span-2">
                                    <NKUploadMultipleImage label="Hình ảnh" name="imageUrls" />
                                </div>
                                <div className="sm:col-span-2">
                                    <button
                                        type="submit"
...
export const Route = createFileRoute('/_app-layout/app/user-me-sale-booking/$id/edit/')({
    component: Page,
});
