    ...
    return (
        <div className="fade-in relative flex w-full flex-1 flex-col bg-white">
            ...
            <div className="mt-3 flex flex-col gap-2 px-4">
                ...
                <div className="">
                    <NKLink href={NKRouter.app.post.user(userState.id)} className="flex items-center justify-between gap-2  py-3 font-semibold">
                    ...
                    <NKLink href={NKRouter.app.settings.update()} className="flex items-center justify-between gap-2  py-3 font-semibold">
                        <div className="flex items-center justify-center">
                    ...
                    <NKLink href={NKRouter.app.settings.wallet.index()} className="flex items-center justify-between gap-2  py-3 font-semibold">
                        <div className="flex items-center justify-center">
                            <div>Ví Của Tôi</div>
                        </div>
                        <div className="h-6 w-6">
                    ...
                    <NKLink href={NKRouter.app.settings.changePassword()} className="flex items-center justify-between gap-2  py-3 font-semibold ">
                        <div className="flex items-center justify-center">
                ...
                <div className="">
                    <NKLink href={NKRouter.app.userMeSale.index()} className="flex items-center justify-between gap-2  py-3 font-semibold">
                        <div className="flex items-center justify-center">
                            <div>Snapix Shop</div>
                        </div>
                        <div className="h-6 w-6">
                    ...
                    <NKLink href={NKRouter.app.userMeSaleBooking.index()} className="flex items-center justify-between gap-2  py-3 font-semibold">
                        <div className="flex items-center justify-center">
                ...
                <div className="">
                    <NKLink href={NKRouter.app.contactUs.index()} className="flex items-center justify-between gap-2 py-3  font-semibold ">
                        <div className="flex items-center justify-center">
                    ...
                    <NKLink href={NKRouter.app.settings.terms()} className="flex items-center justify-between gap-2 py-3  font-semibold ">
                        <div className="flex items-center justify-center">
                    ...
                    <NKLink href={NKRouter.app.settings.policy()} className="flex items-center justify-between gap-2 py-3  font-semibold ">
                        <div className="flex items-center justify-center">
...
export const Route = createFileRoute('/_app-layout/app/settings/')({
    component: Page,
});
