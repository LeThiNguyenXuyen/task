            ...
            {Boolean(userMeQuery.data?.id) && (
                <>
                    <div className="relative">
                        <NKLink href={NKRouter.app.settings.index()} className="absolute left-4  top-4 h-6 w-6 rounded-lg bg-white/90 text-black">
                            <div>
...
export const Route = createFileRoute('/_app-layout/app/settings/language/')({
    component: Page,
});
