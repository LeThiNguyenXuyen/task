        ...
        <div className="flex flex-col gap-10 text-black">
            <div className="flex flex-col gap-6">
                ...
                <Descriptions bordered>
                    ...
                    <Descriptions.Item span={3} label="Số dư đang chờ xử lý" className="font-semibold">
                        {formatMoneyVND(meWallet.data?.pendingBalance || 0)}
                    </Descriptions.Item>
                    <Descriptions.Item span={3} label="Số dư bị đóng băng" className="font-semibold">
                        {formatMoneyVND(meWallet.data?.blockBalance || 0)}
                    </Descriptions.Item>
                </Descriptions>
            </div>
            <div className="flex flex-col gap-6">
                ...
                <TableBuilder
                    columns={[
                        ...
                        //         const data = _get(props, 'id', '').slice(0, 8);
...

                        {
                            ...
                            render: (props: UserWalletTransaction) => {
                                ...
                                return <FieldTime value={data} format="MMMM Do YYYY, h:mm:ss a" />;
                            },
                        },
