...
const Layout: React.FunctionComponent<LayoutProps> = () => {
    return (
        <UnAuthWrapper>
            <div className="faded-in  flex w-full justify-start bg-white bg-[url(https://images.unsplash.com/photo-1556909172-bd5315ff61a0?q=80&w=3570&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)] bg-cover px-20 py-10">
