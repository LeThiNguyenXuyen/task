                                ...
                                <div>
                                    ...
                                    <div className="mt-4 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-4">
                                        <div className="sm:col-span-2">
                                            <NKTextField label="Họ và tên" name="name" theme={NKTextFieldTheme.AUTH} />
                                        </div>
                                        <div className="sm:col-span-2">
                                            <NKTextField label="Số điện thoại" name="phone" theme={NKTextFieldTheme.AUTH} />
                                        </div>

                                        <div className="sm:col-span-2">
                                            <NKTextareaField label="Địa chỉ" name="address" theme={NKTextareaFieldTheme.AUTH} />
                                        </div>
                                    </div>
                                </div>
