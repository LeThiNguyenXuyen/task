...
const Page: React.FC<PageProps> = () => {
    ...
    return (
        <div className="fade-in  flex h-screen w-full  flex-col bg-white">
            <div className={`fixed left-0 top-0 z-[9999] flex h-screen w-full  flex-col border bg-cover`}>
                <div
                ...
                >
                    <div className="inline-block rounded-md bg-white/70  px-8 py-2 text-black">
                        ...
                        <div className="text-center text-sm">We are here to help you</div>
                    </div>
                ...
                <div className="w-full bg-white py-6">
                    <form className="flex w-full rounded-sm px-4 ">
                        <input
