                ...
                <div className="flex-1 items-center flex justify-center">
                    ...
                    >
                        <div className="">
                            ...
                            <div className="text-xs text-center mt-12 mb-2">Break Language Barriers, Connect with Ease</div>
                            <div className="flex flex-col gap-5 w-[300px]">
                                ...
                                <div className="flex w-full justify-end">
                                    <Link href={NKRouter.auth.forgotPassword()} className="text-gray-500 text-xs font-medium">
                                        Forget the password?
                                    </Link>
                                </div>
