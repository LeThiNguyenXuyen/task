...
export interface UserMeSaleBookingIV1CreateDto extends Pick<UserSaleBooking, 'name' | 'description' | 'imageUrls' | 'price' | 'extraFee'> {
    serviceCategoryId: string;
}

export interface UserMeSaleBookingIV1UpdateDto extends Pick<UserSaleBooking, 'name' | 'description' | 'imageUrls' | 'price' | 'extraFee'> {
    serviceCategoryId: string;
}
